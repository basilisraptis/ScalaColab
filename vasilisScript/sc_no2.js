var no2_group = new L.featureGroup([]);
        ...
        map.getPane('pane_sc_no2_3_1').style.zIndex = 407;
        ...
        no2_group.addLayer(layer_sc_no2_3_1);
        


        map.createPane('pane_sc_no2_2_2');
        map.getPane('pane_sc_no2_2_2').style.zIndex = 408;
        ...
        no2_group.addLayer(layer_sc_no2_2_2);
       


        map.createPane('pane_sc_no2_1_3');
        map.getPane('pane_sc_no2_1_3').style.zIndex = 409;
        ...
        no2_group.addLayer(layer_sc_no2_1_3);

var pm10_group = new L.featureGroup([]);
        ...
        map.getPane('pane_sc_pm10_4_0').style.zIndex = 410;
        ...
        pm10_group.addLayer(layer_sc_pm10_4_0);
        


        map.createPane('pane_sc_pm10_3_1');
        map.getPane('pane_sc_pm10_3_1').style.zIndex = 411;
        var img_sc_pm10_3_1 = 'dataa/sc_pm10_3_1.png';
        ...
        pm10_group.addLayer(layer_sc_pm10_3_1);
        


        map.createPane('pane_sc_pm10_2_2');
        map.getPane('pane_sc_pm10_2_2').style.zIndex = 412;
        var img_sc_pm10_2_2 = 'dataa/sc_pm10_2_2.png';
        ...
        pm10_group.addLayer(layer_sc_pm10_2_2);
        


        map.createPane('pane_sc_pm10_1_3');
        map.getPane('pane_sc_pm10_1_3').style.zIndex = 413;
        var img_sc_pm10_1_3 = 'dataa/sc_pm10_1_3.png';
        ...
        pm10_group.addLayer(layer_sc_pm10_1_3);
